package org.javaacademy.module1.core.lesson1;
...
public class Lesson1 {
    public static void main(String... args) {
        ...
        System.out.println("Деление целочисленного числа с остатком");
        double result = (float) 10 / 3;
        System.out.println(result);

        String test = "sddsdsds";
        boolean s = test.contains("s");
        ...
        //136 - k
        //138 - m
        System.out.println("Печать кода символа: " + (int) randomSymbol);
        ...
        //Повторения текста n раз c новой строки
        System.out.println("___________________________________________");
        String name2 = String.format("%s\n", name);
        String nameFiftyTimes2 = name2.repeat(50);
        System.out.println("Юрий 50 раз:" + nameFiftyTimes2);
        System.out.println("___________________________________________");
